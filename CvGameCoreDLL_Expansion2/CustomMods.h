...
#define MOD_AUTO_REMOVE_PROMOTIONS 		   		                gCustomMods.isAUTO_REMOVE_PROMOTIONS()

#ifdef MOD_PROMOTION_SPLASH_DAMAGE
#define MOD_NEW_BATTLE_EFFECTS (MOD_PROMOTION_SPLASH_DAMAGE || MOD_PROMOTION_COLLATERAL_DAMAGE || MOD_PROMOTION_ADD_ENERMY_PROMOTIONS)
#endif
...
public:
	...
	MOD_OPT_DECL(AUTO_REMOVE_PROMOTIONS);
